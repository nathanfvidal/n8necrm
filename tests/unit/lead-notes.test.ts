...
async function limparDadosDeTeste() {
  ...
  // Ordem importa por causa das FKs: AuditLog (entidadeId por string, sem FK
  // real, mas ainda é dado de teste a limpar) → Lead (LeadNote cai junto via
  // onDelete: Cascade no schema, sem precisar de deleteMany separado) →
  // Contact.
